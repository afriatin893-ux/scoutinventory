...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-header">{{ __('Barang Paling Sering Dipinjam') }}</div>
        <div class="card-body">
            <table class="table table-sm mb-0">
                ...
                <tbody>
                    @forelse ($barangTerpopuler as $item)
                        <tr>
                    ...
                    @empty
                        <tr>
                            <td colspan="2" class="text-muted">{{ __('Belum ada data peminjaman.') }}</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
